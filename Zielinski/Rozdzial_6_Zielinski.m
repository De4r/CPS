...
% Butterwortha
% Dane projektowe
fpass = 8000;       % czêsto. pasma przepustowego odpowiadaj¹ca apass
fstop = 22050;      % czêsto. pasma zaporowego odpowiadaj¹ca astop
...
figure(51)
plot( real(z), imag(z), 'o',real(p),imag(p),'x' ); grid;
title(['Po³o¿enie biegunów dla filtra LowPass']);
xlabel('real'); ylabel('imag');
printsys(b,a,'s');
