% 1. Wygeneruj N=1000 próbek sygna³u sinusoidalnego x(t)=Asin(2?fxt) o amplitudzie A=5 i o czêstotliwoœci
% fx=10 Hz, spróbkowanego z czêstotliwoœci¹ fp=1000 Hz. Narysuj ten sygna³.
%                                                           Mateusz Krupnik
disp('1. Wygeneruj N=1000 próbek sygna³u sinusoidalnego x(t)=Asin(2?fxt) o amplitudzie A=5 i o czêstotliwoœci fx=10 Hz, spróbkowanego z czêstotliwoœci¹ fp=1000 Hz. Narysuj ten sygna³.')
...
%% 2. Wygeneruj N=1000 próbek szumu o rozk³adzie równomiernym i normalnym (gaussowskim). Wyznacz dla nich
% funkcjê autokorelacji, autokowariancji, histogram, szereg Fouriera i periodogram.
disp('2. Wygeneruj N=1000 próbek szumu o rozk³adzie równomiernym i normalnym (gaussowskim). Wyznacz dla nich funkcjê autokorelacji, autokowariancji, histogram, szereg Fouriera i periodogram.')
...
%% 3. Dodaj sygna³y z punktu 1 i 2. Wyznacz i narysuj funkcjê autokorelacji, autokowariancji i histogram sygna³u
% sumarycznego.
disp('Zadanie 3. Dodaj sygna³y z punktu 1 i 2. Wyznacz i narysuj funkcjê autokorelacji, autokowariancji i histogram sygna³u sumarycznego.')
% Dodawanie sygna³ów
...
%% 4. Powtórz operacje z punktu 3 po dodaniu do sygna³u 1+2 jeszcze jednej sinusoidy o czêstotliwoœci 250 Hz.
disp('4. Powtórz operacje z punktu 3 po dodaniu do sygna³u 1+2 jeszcze jednej sinusoidy o czêstotliwoœci 250 Hz.')
...
%% 6. Wygeneruj sygna³ sinusoidalny z liniow¹ modulacja czêstotliwoœci (?=?x+?t) oraz z sinusoidaln¹ modulacj¹
% czêstotliwoœci ((?=?x+sin(?mt)).
disp('6. Wygeneruj sygna³ sinusoidalny z liniow¹ modulacja czêstotliwoœci (?=?x+?t) oraz z sinusoidaln¹ modulacj¹ czêstotliwoœci ((?=?x+sin(?mt)).')
% Generowanie wykresow i sygna³ów
figure();
fx = 0; alfa = 50;
...
%% 8. „Spleæ" ze sob¹ dwa sygna³y, czyli dokonaj filtracji jednego z nich przez
% drugi.
disp('8. „Spleæ" ze sob¹ dwa sygna³y, czyli dokonaj filtracji jednego z nich przez drugi.')
% Generowanie sygna³ów
